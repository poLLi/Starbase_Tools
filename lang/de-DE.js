    ...
    BUILDER: {
        CARD: {
            ...
            PERK_POINTS_DESCRIPTION:
                'Sie müssen ein Wert von 0 oder mehr Perk Punkten haben um den Build fertig zu stellen.',
        ...
        OCCUPATION: {
            ...
            UNEMPLOYED_DESCRIPTION:
                'Du warst ein Talentierter und schneller Lerner, der sich gegen eine Beschäftigung entschieden hat.',
            ...
            CONSTRUCTION_WORKER_DESCRIPTION:
                'Du bist es gewohnt die ganze Zeit auf dem Bau zu arbeiten. Das ist die ideale Wahl, wenn du Strukturen bauen möchtest.',
            ...
            FARMER_DESCRIPTION:
                'Einen ehrlichen Lebensunterhalt zu verdienen, ist niemals etwas, wofür man sich schämen muss. Jeder muss etwas zu essen haben.',
            FARMER_BENEFIT: 'Spawn mit ein paar einfachen Klamotten und einem Rucksack mit Überlebensausrüstung.',

            CHEF_TITLE: 'Koch',
            CHEF_DESCRIPTION:
                'Du warst schon immer gern in der Küche, seit du ein Kind warst. Jetzt musst Du deine Kochkünste einsetzen um zu überleben.',
            CHEF_BENEFIT: 'Spawn mit deinem Koch Outfit und einem Küchenmesser.',

            DOCTOR_TITLE: 'Arzt',
            DOCTOR_DESCRIPTION:
                'Theoretisch gilt der hippokratische Eid auch nach dem Zerfall der Gesellschaft noch. Du hast einmal geschworen, den Bedürftigen zu helfen.',
            ...
            FIRE_FIGHTER_DESCRIPTION:
                'Du warst einmal ein Feuerwehrmann und hast tapfer gegen viele der Feuer gekämpft, die während des Ausbruchs entfacht sind. Du bist einer der wenigen Überlebenden aus der Stadt.',
            ...
            POLICE_OFFICER_DESCRIPTION:
                'Du warst einmal Polizist und hast das Gesetz durchgesetzt. Dies ist jetzt eine gesetzlose Welt.',
            POLICE_OFFICER_BENEFIT:
                'Spawn mit deinem Polizei Outfit, einer Taschenlampe und einer Dienstwaffe mit weniger als einem halben Magazin.',

            SECURITY_GUARD_TITLE: 'Wachmann',
            SECURITY_GUARD_DESCRIPTION:
                'Du hast nachts nie wirklich gut geschlafen, also bist du ein Wachmann im Einkaufszentrum geworden.',
        ...
        PERK: {
            ...
            ASTRONOMER_DESCRIPTION:
                'Zeige nachts einen Kompass auf dem Bildschirm an, wenn die HUD-Taste gerückt wird.',
            ...
            PEANUT_ALLERGY_DESCRIPTION:
                'Löst beim Verzehr von erdnusshaltigen Lebensmitteln eine schwere allergische Reaktion aus. (Spawn mit einem Epi-Pen).',
            ...
            UNIVERSAL_RECEIVER_DESCRIPTION:
                'Setzt deine Blutgruppe auf AB+, wodurch Du blut von jedem anderen Typ erhalten kannst, ohne eine hämolytische Reaktion auszulösen.',

            UNIVERSAL_DONOR_TITLE: 'Universal Spender',
            UNIVERSAL_DONOR_DESCRIPTION:
                'Setzt deine Blutgruppe auf 0-, wodurch Du jedem anderen Typ eine Transfusion geben kannst wenn er eine benötigt.',
            ...
            RUNNER_TITLE: 'Läufer',
            RUNNER_DESCRIPTION:
                'Früher bist du gerne Marathons gelaufen. Erhalte + 300s extra Sprintzeit und +1 Beweglichkeit.',

            STRENGTH_TRAINING_TITLE: 'Krafttraining',
            STRENGTH_TRAINING_DESCRIPTION:
                'Dein Leben orientiert sich an Gewichte-Heben, wenn du nicht bei der Arbeit bist. Erhalte +2 Stärke.',

            WEEKEND_BARTENDER_TITLE: 'Wochenend-Barkeeper',
            WEEKEND_BARTENDER_DESCRIPTION:
                'Du hast gerne am Wochenende als Barkeeper gearbeitet, es gab dir einen Einblick in das menschliches Verhalten. Erhalte +2 Chraisma.',

            WRESTLER_TITLE: 'Ringer',
            WRESTLER_DESCRIPTION:
                'Du warst ein Ringer, als du jünger warst, das hat es ziemlich schwer gemacht, dich zu Fall zu bringen. Erhalte +2 Ausdauer.',

            AMATEUR_COOK_TITLE: 'Hobbykoch',
            AMATEUR_COOK_DESCRIPTION:
                'Du kochst gerne ausgefallene Mahlzeiten zu Hause und hast keine Angst hinter den Herd zu stehen. Erhalte +25 Kochen.',
            ...
            METALWORKER_DESCRIPTION:
                'Du hast viel an Metallarbeiten und Schlosserarbeiten herumgebastelt. Erhalte +25 Lockpicking.',
            ...
            HOBBYIST_DESCRIPTION:
                'Du genießst es mit Modelleisenbahnen, Raketen und verschiedensten Geräten zu spielen. Erhalte +25 Handwerk',

            GEARHEAD_TITLE: 'Getriebe',
            GEARHEAD_DESCRIPTION:
                'Du hast viel Zeit damit verbracht alte Autos zu restaurieren. Erhalte +25 Mechaniker.',

            VOLUNTEER_FIRE_FIGHTER_TITLE: 'Freiwillige Feuerwehr',
            VOLUNTEER_FIRE_FIGHTER_DESCRIPTION:
                'Du warst bei der freiwilligen Feuerwehr als Du jünger warst. Erhalten +25 Medical.',
            ...
            NO_FEAR_DESCRIPTION:
                'Du hast schon alles gesehen und keine Angst mehr vor dem Tod. Werde 80% weniger unterdrückt bei beschuss.',
